## Aggregated features for credit card fraud detection
...
Checkout the notebook "Aggregated_Features.ipynb" for calculating the set of features for capturing the customer spending pattern.
